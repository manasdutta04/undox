...
**Film layout:** TrueForge chat on the **left** (tools / approval / subagents); Exposure Dashboard on the **right** (`http://127.0.0.1:8793/?session=…`).
...
7. Note a session id you will reuse: e.g. `demo-double-o-1` (open the same id in the dashboard).
...
| 0:20–0:50 | **Subagents:** orchestrator fans out across Spokeo + two fixture brokers. | Tool / subagent spans; dashboard brokers appear as `found` |
